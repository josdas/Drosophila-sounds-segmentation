...
def Muha_analysis_v1(currentDT, start, end):
    numDTtest1 = len(currentDT[start:end]);
    i = 0
...
annotaionRESULT = {'agn/AD7': Muha_analysis_v1(DT, 0, 25), 'agn/n': Muha_analysis_v1(DT, 25, 45),
                   'CS/AD7': Muha_analysis_v1(DT, 45, 58), 'CS/n': Muha_analysis_v1(DT, 58, 81)}
...
processingRESULT1 = {'agn/AD7': Muha_analysis_v2(DT_new, 0, 25), 'agn/n': Muha_analysis_v2(DT_new, 25, 45),
                     'CS/AD7': Muha_analysis_v2(DT_new, 45, 58), 'CS/n': Muha_analysis_v2(DT_new, 58, 81)}
...
processingRESULT2 = {'agn/AD7': Muha_analysis_v3(DT_old_new, 0, 25), 'agn/n': Muha_analysis_v3(DT_old_new, 25, 45),
                     'CS/AD7': Muha_analysis_v3(DT_old_new, 45, 58), 'CS/n': Muha_analysis_v3(DT_old_new, 58, 81)}
...
processingRESULT3 = {'agn/AD7': MeanTime_v4(6.14), 'agn/n': MeanTime_v4(4.2), 'CS/AD7': MeanTime_v4(1.1),
                     'CS/n': MeanTime_v4(3.6)}
